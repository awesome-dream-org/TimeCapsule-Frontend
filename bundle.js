...
/***/ function(module, exports, __webpack_require__) {
	...
	var navEvents = __webpack_require__(39);
	var docEvents = __webpack_require__(45);
	var titleTemplate = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<aside>"
	    ...
	    + "</aside>\n<article>\n\n<div class=\"wrapper launch\">\n\n<div class=\"image\">\n\n  <div class=\"file-names manage\">\n    <figure><a id=\"my-files-link\" href=\"#\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file one\" /></a></figure>\n    <p>Manage Files</p>\n  </div>\n\n  <div class=\"file-names upload\">\n    <figure><a id=\"upload-file-link\" href=\"#\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file\" /></a></figure>\n    <p>Upload Files</p>\n  </div>\n\n  <div class=\"file-names view\">\n    <figure><a id=\"all-files-link\" href=\"#\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file two\" /></a></figure>\n    <p>View Files</p>\n  </div>\n</div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpTemplate = __webpack_require__(42);
	var signInTemplate = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetAllFiles = function onGetAllFiles(event) {
	  event.preventDefault();
	  api.getAllDocs().then(ui.getAllDocsSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateDoc = function updateDoc(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <tr>\n          <td>"
	    ...
	    + "\" type=\"button\" class=\"btn-sm btn-defaults\">\n              Download\n            </button>\n          </td>\n          <td>\n            <a href=\"#\">\n              <button id=\"update-doc-open\" type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#update-doc-modal\">\n                <span class=\"glyphicon glyphicon-pencil\"></span>\n              </button>\n            </a>\n          </td>\n          <td>\n            <a href=\"#\">\n              <form id=\"delete-doc-button\">\n                <button type=\"button\" class=\"btn btn-primary btn-lg\">\n                  <span class=\"glyphicon glyphicon-trash\"></span>\n                </button>\n              </form>\n            </a>\n          </td>\n        </tr>\n\n        <!-- Update Docs Modal -->\n        <div class=\"modal fade\" id=\"update-doc-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\">Edit a File</h4>\n              </div>\n              <div class=\"modal-body\">\n                <form id=\"update-doc\" class=\"modal-form\">\n                  <div class=\"form-group\">\n                    <input name=\"docs[ID]\" type=\"text\" class=\"form-control\" id=\"update-doc-id\" placeholder=\"Enter ID of File.\">\n                  </div>\n                  <div>\n                    <input name=\"file[title]\" type=\"text\" class=\"form-control\" id=\"update-doc-title\" placeholder=\"Enter title of File.\">\n                    <!-- aria-describedby=\"emailHelp\" <=this goes inside input tag above\n                      <small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your email with anyone else.</small> -->\n                  </div>\n                  <br>\n                  <div class=\"form-group\">\n                    <input name=\"file[category]\" type=\"text\" class=\"form-control\" id=\"update-doc-category\" placeholder=\"Enter category of File.\">\n                  </div>\n                  <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n                  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n                </form>\n              </div>\n            </div>\n          </div>\n        </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateCategorySelect = function updateCategorySelect(data) {
	  ...
	  for (var i = 0; i < data.categories.length; i++) {
	    list.options[list.options.length] = new Option(data.categories[i].text, data.categories[i].id);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h3 class=\"description\">Dig up some files and see what may be buried out there!</h3>\n";
	},"useData":true});
