...
/***/ function(module, exports, __webpack_require__) {
	...
	var navEvents = __webpack_require__(41);
	var docEvents = __webpack_require__(45);
	var titleTemplate = __webpack_require__(38);
	var signUpTemplate = __webpack_require__(43);
	var signInTemplate = __webpack_require__(37);
	var changePassWordTemplate = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<article>\n  <div class=\"wrapper launch\">\n    <div class=\"image\">\n      <div class=\"file-names upload\">\n        <figure>\n          <a id=\"upload-file-link\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file\" /></a>\n        </figure>\n        <p>Upload Files</p>\n      </div>\n      <div class=\"file-names manage\">\n        <figure>\n          <a id=\"my-files-link\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file one\" /></a>\n        </figure>\n        <p>My Files</p>\n      </div>\n      <div class=\"file-names view\">\n        <figure>\n          <a id=\"all-files-link\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file two\" /></a>\n        </figure>\n        <p>All Files</p>\n      </div>\n    </div>\n  </div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<article>\n  <p class=\"description\">\n    The Time Capsule app is a collection of user uploaded documents.\n    The purpose of the app is to give users a place to upload documents\n    that they deem important to the current day. Each document is tied to\n    a specific category.\n\n    Files are uploaded to AWS. Users can download the files from all users,\n    but only have the ability to update and delete the files they've uploaded.\n  </p>\n</article>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changePasswordSuccess = 'You have successfully changed your password.';

	// Doc messages
	var createSuccess = 'Document has been uploaded successfully.';
	var createFailure = 'You are missing required fields. Try again?';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var catEvents = __webpack_require__(51);
	var catUI = __webpack_require__(53);
	var catAPI = __webpack_require__(52);
	...
	var onUpdateDoc = function onUpdateDoc(event) {
	  ...
	  if ($('#title-' + id).val()) {
	    api.updateDoc(id, title, category).done(function () {
	      ui.updateDocSuccess();
	      onMyFiles();
	    }).fail(ui.failure);
	  } else {
	...
	var onDownloadDoc = function onDownloadDoc(event) {
	  event.preventDefault();
	  var id = event.currentTarget.id.replace('download-', '');
	  api.getDoc(id).then(ui.getDocSuccess).catch(ui.failure);
	};

	var onDeleteDoc = function onDeleteDoc(event) {
	  event.preventDefault();
	  var id = event.currentTarget.id.replace('delete-', '');
	  api.deleteDoc(id).done(function () {
	    api.getAllMyDocs().done(function () {
	      ui.updateDocSuccess();
	      onMyFiles();
	    }).fail(ui.failure);
	  }).done(ui.deleteDocSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myFilesTemplate = __webpack_require__(48);
	var allFilesTemplate = __webpack_require__(49);
	var uploadFileTemplate = __webpack_require__(50);
	var msg = __webpack_require__(39);
	...
	var createDocSuccess = function createDocSuccess() {
	  msg.setUserMessage(msg.createSuccess);
	  $('#create-document-form').trigger('reset');
	};

	var createDocFailure = function createDocFailure() {
	...
	module.exports = {
	  ...
	  failure: failure,
	  updateDocInvalidTitle: updateDocInvalidTitle,
	  createDocFailure: createDocFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateCategorySelectMulti = function updateCategorySelectMulti(docs, categories) {
	  $('.category-list').each(function (itemNo, item) {
	    var categoryList = sortCategoryList(categories);
	    var list = $(item)[0];
	    for (var i = 0; i < categoryList.length; i++) {
	      list.options[list.options.length] = new Option(categoryList[i].text, categoryList[i].id);
	    }
