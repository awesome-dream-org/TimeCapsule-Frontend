...
/***/ function(module, exports, __webpack_require__) {
	...
	var navEvents = __webpack_require__(42);
	var docEvents = __webpack_require__(46);
	var titleTemplate = __webpack_require__(39);
	var signUpTemplate = __webpack_require__(44);
	var signInTemplate = __webpack_require__(38);
	var changePassWordTemplate = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(41);
	...
	var matchingPasswords = function matchingPasswords(password1, password2) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(15);
	var launchTemplate = __webpack_require__(17);
	var signInTemplate = __webpack_require__(38);
	var titleTemplate = __webpack_require__(39);
	var msg = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<aside>"
	    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"user-message","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</aside>\n<article>\n\n<div class=\"wrapper launch\">\n\n<div class=\"image\">\n\n  <div class=\"file-names upload\">\n    <figure><a id=\"upload-file-link\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file\" /></a></figure>\n    <p>Upload Files</p>\n  </div>\n\n  <div class=\"file-names manage\">\n    <figure><a id=\"my-files-link\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file one\" /></a></figure>\n    <p>Manage Files</p>\n  </div>\n\n  <div class=\"file-names view\">\n    <figure><a id=\"all-files-link\"><img src=\"https://maxcdn.icons8.com/Share/icon/Very_Basic//folder1600.png\" alt=\"\" class=\"file two\" /></a></figure>\n    <p>View Files</p>\n  </div>\n</div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<aside><div id=\"user-message\" class=\"user-message\">&nbsp;</div></aside>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"sign-in frame\">\n\n<h3 class=\"header-sign-in\">Sign In</h3>\n\n<form id=\"sign-in\">\n <input class=\"input\" type=\"text\" name=\"credentials[email]\" placeholder=\"email\"><br>\n <input class=\"input\" type=\"password\" name=\"credentials[password]\" placeholder=\"password\"><br>\n <button type=\"submit\" id=\"btn-two\">Submit</button>\n</form>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<p class=\"description\">The Time Capsule app is a collection of user uploaded documents. The purpose of the app is to give users a place to upload documents that they deem important to the current day. Each document is tied to one of the below categories.</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var genericError = 'Something went wrong. Try again?';

	// Auth messages
	var invalidEmail = 'Your email is not valid. Try again?';
	var mismatchedPasswords = 'These passwords don\'t match. Try again?';
	var missingInput = 'You are missing some fields. Try again?';
	var signUpSuccess = 'You have successfully signed up. Please log-in with your new credentials.';
	var invalidCredentials = 'The username or password you entered is incorrect. Try again?';
	var invalidCurrentPassword = 'Your current password is incorrect. Try again?';
	var signOutSuccess = 'You have successfully signed out.';
	var changePasswordSuccess = 'You have successfully changed your password. ' + 'Please log-in with your new credentials.';

	// Doc messages
	var createSuccess = 'Document has been uploaded successfully.';
	var downloadSuccess = 'Document has been downloaded successfully.';
	var updateSuccess = 'Document has been updated successfully.';
	var deleteSuccess = 'Document has been deleted successfully.';
	var noUserDocs = "You don't have any files. Please select 'Launch Page' from the nav bar to go back.";
	var noDocs = "There aren't currently any files. Please select 'Launch Page' from the nav bar to go back.";
	var updateDocInvalidTitle = "You can't have a blank title. Try again?";

	var userMessageElement = '#user-message';

	var clearUserMessage = function clearUserMessage() {
	...
	module.exports = {
	  ...
	  noUserDocs: noUserDocs,
	  noDocs: noDocs,
	  updateDocInvalidTitle: updateDocInvalidTitle
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Open the side bar
	var onSideBarBtn = function onSideBarBtn() {
	  $('#sidebar').toggleClass('visible');
	};
	...
	var onLaunchPage = function onLaunchPage() {
	  ui.showLaunchPage();
	  $('#sidebar').toggleClass('visible');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showLaunchPage = function showLaunchPage() {
	  $('#content').html(launchTemplate());
	  $('#launch-page-nav').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<aside>"
	    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"user-message","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</aside>\n<div class=\"sign-up frame\">\n\n    <h3 class=\"header-sign-up\">Sign up</h3>\n\n    <form id=\"sign-up\">\n      <input class=\"input\" type=\"text\" name=\"credentials[email]\" placeholder=\"email\"><br>\n      <input class=\"input\" type=\"password\" name=\"credentials[password]\" placeholder=\"password\"><br>\n      <input class=\"input\" type=\"password\" name=\"credentials[password_confirmation]\" placeholder=\"confirm password\"><br>\n      <button type=\"submit\" id=\"btn-one\">Submit</button>\n    </form>\n  </div>\n";
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"change-password frame\">\n\n  <h3 class=\"header-change-password\">Change Password</h3>\n\n  <form id=\"change-password\">\n    <input class=\"input\" type=\"password\" name=\"passwords[old]\" placeholder=\"old password\"><br>\n    <input class=\"input\" type=\"password\" name=\"passwords[new]\" placeholder=\"new password\"><br>\n    <button type=\"submit\" id=\"btn-three\">Submit</button>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var catEvents = __webpack_require__(53);
	var catUI = __webpack_require__(55);
	var catAPI = __webpack_require__(54);

	var onMyFiles = function onMyFiles() {
	  event.preventDefault();
	  api.getAllMyDocs().done(function (docsResult) {
	    ui.showMyDocs(docsResult);
	    catAPI.getAllCats().done(function (catsResult) {
	...
	var onUpdateDoc = function onUpdateDoc(event) {
	  event.preventDefault();
	  var id = event.currentTarget.id.replace('update-', '');
	  var title = $('#title-' + id).val();
	  var category = $('#category-' + id).val();

	  if ($('#title-' + id).val()) {
	    api.updateDoc(id, title, category).then(ui.updateDocSuccess).then(onMyFiles).catch(ui.failure);
	  } else {
	...
	var onGetAllFiles = function onGetAllFiles(event) {
	  event.preventDefault();
	  api.getAllDocs().then(ui.getAllDocsSuccess).then(function () {
	    $('table').filterTable({
	      filterExpression: 'filterTableFindAny',
	      minRows: 0
	    });
	...
	var onCreateDoc = function onCreateDoc(event) {
	  event.preventDefault();
	  var data = new FormData(event.target);
	  api.createDoc(data).then(ui.createDocSuccess).catch(ui.failure);
	};

	var onDownloadDoc = function onDownloadDoc(event) {
	  event.preventDefault();
	  var id = event.target.id.replace('download-', '');
	  api.getDoc(id).then(ui.getDocSuccess).catch(ui.failure);
	};

	var onDeleteDoc = function onDeleteDoc(event) {
	  event.preventDefault();
	  var id = event.target.id.replace('delete-', '');
	  api.deleteDoc(id).then(function () {
	    api.getAllMyDocs().then(ui.showMyDocs).catch(ui.failure);
	  }).then(ui.deleteDocSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllDocs = function getAllDocs() {
	  return $.ajax({
	...
	var getAllMyDocs = function getAllMyDocs() {
	  return $.ajax({
	...
	var createDoc = function createDoc(data) {
	  return $.ajax({
	    url: config.host + '/docs',
	    method: 'POST',
	    data: data,
	...
	var updateDoc = function updateDoc(id, title, category) {
	  return $.ajax({
	    url: config.host + '/docs/' + id,
	    method: 'PATCH',
	    data: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myFilesTemplate = __webpack_require__(49);
	var allFilesTemplate = __webpack_require__(50);
	var uploadFileTemplate = __webpack_require__(51);
	var noFilesTemplate = __webpack_require__(52);
	var msg = __webpack_require__(40);

	var showMyDocs = function showMyDocs(myFiles) {
	...
	var showCreateDocForm = function showCreateDocForm() {
	...
	var getAllDocsSuccess = function getAllDocsSuccess(allFiles) {
	...
	var getDocSuccess = function getDocSuccess(data) {
	  window.location.assign(data.doc.url);
	  msg.setUserMessage(msg.downloadSuccess);
	};

	var updateDocSuccess = function updateDocSuccess() {
	  msg.setUserMessage(msg.updateSuccess);
	};

	var updateDocInvalidTitle = function updateDocInvalidTitle() {
	...
	module.exports = {
	  ...
	  getAllDocsSuccess: getAllDocsSuccess,
	  getDocSuccess: getDocSuccess,
	  createDocSuccess: createDocSuccess,
	  updateDocSuccess: updateDocSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <tr>\n          <td><input type=\"text\" id=\"title-"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" name=\"doc[category]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.category : stack1), depth0))
	    + "\" class=\"category-list\"><option value=\"\" selected disabled>Select a Category...</option>\n          </select></td>\n          <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.filterDate : stack1), depth0))
	    + "</td>\n          <td>\n            <button class=\"download-btn btn btn-primary btn-lg\" id=\"download-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" type=\"button\">\n              <span class=\"glyphicon glyphicon-download-alt\"></span>\n            </button>\n          </td>\n          <td>\n            <button class=\"update-btn btn btn-primary btn-lg\" id=\"update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" type=\"submit\">\n              <span class=\"glyphicon glyphicon-pencil\"></span>\n            </button>\n          </td>\n          <td>\n            <button id=\"delete-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" type=\"button\" class=\"delete-btn btn-primary btn-lg\">\n              <span class=\"glyphicon glyphicon-trash\"></span>\n            </button>\n          </td>\n        </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<aside>"
	    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"user-message","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</aside>\n<article>\n  <div class=\"filter-table\">\n    <table class=\"file-table-one filter-table quick\">\n      <thead>\n        <tr>\n          <th>File Name</th>\n          <th>Category</th>\n          <th>Date Created</th>\n          <th>Download</th>\n          <th>Update</th>\n          <th>Delete</th>\n        </tr>\n      </thead>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<aside>"
	    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"user-message","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</aside>\n<article>\n\n  <div class=\"upload-file\">\n    <form id=\"create-document-form\" method=\"post\" enctype=\"multipart/form-data\">\n    <fieldset>\n      <legend>Create Doc</legend>\n      <label>\n        Title\n        <input type=\"text\" name=\"doc[title]\">\n      </label>\n      <label>\n        Category\n        <select id=\"select-category\" name=\"doc[category]\">\n          <option value=\"\" selected disabled>Select a Category...</option>\n        </select>\n      </label>\n      <label>\n        <input type=\"file\" name=\"doc[file]\">\n      </label>\n      <input type=\"submit\" name=\"submit\" value=\"Create\">\n    </fieldset>\n  </form>\n  </div>\n</article>\n";
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ui = __webpack_require__(55);

	var onGetAllCats = function onGetAllCats(event) {
	  event.preventDefault();

	  api.getAllCats().then(ui.updateCategorySelect).catch(ui.failure);
	};

	module.exports = {
	  onGetAllCats: onGetAllCats
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllCats = function getAllCats() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sortCategoryList = function sortCategoryList(categories) {
	...
	var updateCategorySelect = function updateCategorySelect(data) {
	  var categoryList = sortCategoryList(data.categories);
	  var list = $('#select-category')[0];
	  for (var i = 0; i < categoryList.length; i++) {
	    list.options[list.options.length] = new Option(categoryList[i].text, categoryList[i].id);
	  }
	  $('#select-category').append(list);
	};

	var updateCategorySelectMulti = function updateCategorySelectMulti(docs, categories) {
	  $('.category-list').each(function (itemNo, item) {
	    var list = $(item)[0];
	    for (var i = 0; i < categories.length; i++) {
	      list.options[list.options.length] = new Option(categories[i].text, categories[i].id);
	    }
	    $(item).append(list);
	...
	module.exports = {
	  ...
	  updateCategorySelectMulti: updateCategorySelectMulti,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function ($) {
	  var e = $.fn.jquery.split("."),
	      t = parseFloat(e[0]),
	      n = parseFloat(e[1]);2 > t && 8 > n ? ($.expr[":"].filterTableFind = function (e, t, n) {
	    return $(e).text().toUpperCase().indexOf(n[3].toUpperCase().replace(/"""/g, '"').replace(/"\\"/g, "\\")) >= 0;
	  }, $.expr[":"].filterTableFindAny = function (e, t, n) {
	    var i = n[3].split(/[\s,]/),
	        r = [];return $.each(i, function (e, t) {
	      var n = t.replace(/^\s+|\s$/g, "");n && r.push(n);
	    }), r.length ? function (e) {
	      var t = !1;return $.each(r, function (n, i) {
	        return $(e).text().toUpperCase().indexOf(i.toUpperCase().replace(/"""/g, '"').replace(/"\\"/g, "\\")) >= 0 ? (t = !0, !1) : void 0;
	      }), t;
	    } : !1;
	    ...
	    var i = n[3].split(/[\s,]/),
	      ...
	      var t = 0;return $.each(r, function (n, i) {
	        $(e).text().toUpperCase().indexOf(i.toUpperCase().replace(/"""/g, '"').replace(/"\\"/g, "\\")) >= 0 && t++;
	      }), t === r.length;
	    } : !1;
	    ...
	    var t = e.split(/[\s,]/),
	        n = [];return $.each(t, function (e, t) {
	      var i = t.replace(/^\s+|\s$/g, "");i && n.push(i);
	    }), n.length ? function (e) {
	      var t = !1;return $.each(n, function (n, i) {
	        return $(e).text().toUpperCase().indexOf(i.toUpperCase().replace(/"""/g, '"').replace(/"\\"/g, "\\")) >= 0 ? (t = !0, !1) : void 0;
	      }), t;
	    } : !1;
	    ...
	    var t = e.split(/[\s,]/),
	      ...
	      var t = 0;return $.each(n, function (n, i) {
	        $(e).text().toUpperCase().indexOf(i.toUpperCase().replace(/"""/g, '"').replace(/"\\"/g, "\\")) >= 0 && t++;
	      }), t === n.length;
	    } : !1;
	  })), $.fn.filterTable = function (e) {
	    var t = { autofocus: !1, callback: null, containerClass: "filter-table", containerTag: "p", filterExpression: "filterTableFind", hideTFootOnFilter: !1, highlightClass: "alt", ignoreClass: "", ignoreColumns: [], inputSelector: null, inputName: "", inputType: "search", label: "Filter:", minChars: 1, minRows: 8, placeholder: "search this table", preventReturnKey: !0, quickList: [], quickListClass: "quick", quickListGroupTag: "", quickListTag: "a", visibleClass: "visible" },
	        n = function n(e) {
	      return e.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
	    },
	        i = $.extend({}, t, e),
	        r = function r(e, t) {
	      var n = e.find("tbody");if ("" === t || t.length < i.minChars) n.find("tr").show().addClass(i.visibleClass), n.find("td").removeClass(i.highlightClass), i.hideTFootOnFilter && e.find("tfoot").show();else {
	        var r = n.find("td");if (n.find("tr").hide().removeClass(i.visibleClass), r.removeClass(i.highlightClass), i.hideTFootOnFilter && e.find("tfoot").hide(), i.ignoreColumns.length) {
	          var a = [];i.ignoreClass && (r = r.not("." + i.ignoreClass)), a = r.filter(":" + i.filterExpression + '("' + t + '")'), a.each(function () {
	            var e = $(this),
	        ...
	        } else i.ignoreClass && (r = r.not("." + i.ignoreClass)), r.filter(":" + i.filterExpression + '("' + t + '")').addClass(i.highlightClass).closest("tr").show().addClass(i.visibleClass);
	      ...
	      var e = $(this),
	          ...
	          l = null,
	          s = null,
	          o = !0;"TABLE" === e[0].nodeName && t.length > 0 && (0 === i.minRows || i.minRows > 0 && t.find("tr").length >= i.minRows) && !e.prev().hasClass(i.containerClass) && (i.inputSelector && 1 === $(i.inputSelector).length ? (s = $(i.inputSelector), a = s.parent(), o = !1) : (a = $("<" + i.containerTag + " />"), "" !== i.containerClass && a.addClass(i.containerClass), a.prepend(i.label + " "), s = $('<input type="' + i.inputType + '" placeholder="' + i.placeholder + '" name="' + i.inputName + '" />'), i.preventReturnKey && s.on("keydown", function (e) {
	        return 13 === (e.keyCode || e.which) ? (e.preventDefault(), !1) : void 0;
	      })), i.autofocus && s.attr("autofocus", !0), $.fn.bindWithDelay ? s.bindWithDelay("keyup", function () {
	        r(e, $(this).val());
	      }, 200) : s.bind("keyup", function () {
	        r(e, $(this).val());
	      }), s.bind("click search input paste blur", function () {
	        r(e, $(this).val());
	      }), o && a.append(s), i.quickList.length > 0 && (l = i.quickListGroupTag ? $("<" + i.quickListGroupTag + " />") : a, $.each(i.quickList, function (e, t) {
	        var r = $("<" + i.quickListTag + ' class="' + i.quickListClass + '" />');r.text(n(t)), "A" === r[0].nodeName && r.attr("href", "#"), r.bind("click", function (e) {
	          e.preventDefault(), s.val(t).focus().trigger("click");
	        }), l.append(r);
	      }), l !== a && a.append(l)), o && e.before(a));
	    });
	  };
	}(jQuery);
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
